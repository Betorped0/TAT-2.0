...
namespace TAT001.Common
{
    public class Log
    {
        ...
        public static void ErrorLogApp(System.Exception exception,string controller,string funcion)
        {
            _instance.monitoringLogger.Error("Controller: "+ controller+ " Funcion: "+ funcion+" Mensaje: "+ exception.Message,exception);
        }
    }
}